...
description: 处理 MUC-student 的 React 页面、组件、hook、前端状态、Tauri invoke 封装、DTO 类型、窗口交互和视觉风格。仅在改 `src/pages/`、`src/components/`、`src/hooks/`、`src/lib/`、React 状态流、窗口交互或界面风格时使用；纯 Rust 业务、纯 parser、纯持久化改动不触发。
---
